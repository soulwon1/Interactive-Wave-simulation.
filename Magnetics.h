...
public:
	...
	{
		//Note here we're adding dampening so the magnets don't accelerate indefinitely. 
		// In a real system, you might want to model this more accurately (e.g., with a drag force proportional to velocity).
